...
//
// ── ABOUT THE FIXTURE ────────────────────────────────────────────────────────
// The file that motivated the redesign is a real Qatari audit firm's 2025
// engagement register: 22 columns, real company names, personal mobile numbers
// and personal email addresses. It is NOT in this repo and must not be — this
// repo is pushed to GitHub.
//
// ENGAGEMENT_REGISTER below is an anonymised rebuild of it. Every company,
// person, phone number and email is invented; every STRUCTURAL trap is
// preserved byte-for-byte where it matters:
//
...
const ENGAGEMENT_REGISTER: SheetCell[][] = [
  // 0 — header row
