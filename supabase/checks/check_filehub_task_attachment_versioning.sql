-- Runnable check for the 20260830_filehub_link_task_file_versioning.sql fix:
...
BEGIN
  ...
  RAISE NOTICE 'ALL CHECKS PASSED: filehub_link_task_file versions every new task_attachments/submission_attachments insert (version_no=1, current_version_id set), reuse does not duplicate versions, and no non-deleted filehub_files row is missing a version company-wide.';
END $$;
