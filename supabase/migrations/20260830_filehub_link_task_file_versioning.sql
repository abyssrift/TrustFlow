...
BEGIN
  ...
  RAISE NOTICE 'ALL CHECKS PASSED: 20260830_filehub_link_task_file_versioning.sql -- filehub_link_task_file now versions every new task/submission attachment, and every pre-existing non-deleted file has been backfilled a version.';
END $$;
