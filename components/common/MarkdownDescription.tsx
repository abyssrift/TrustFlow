...
function Inline({ nodes, colors }: { nodes: MarkdownInline[]; colors: ReturnType<typeof useThemeColors> }) {
  return <Text style={{ color: colors.textMain }}>{nodes.map((node, i) => {
