...
export const TimerDeliverabilityChart = ({ data }: Props) => {
  ...
  const colW = chartWidth > 0 ? chartWidth / chartData.length : 0;
            ...
            {chartWidth > 0 && (
              <Svg height={chartHeight} width={chartWidth}>
                ...
                {chartData.map((d, i) => {
                  ...
                  const withinH = Math.max(d.within_budget_tasks > 0 ? 2 : 0, (d.within_budget_tasks / maxTasks) * chartHeight * 0.9);
                  const overH   = Math.max(d.over_budget_tasks > 0 ? 2 : 0, (d.over_budget_tasks / maxTasks) * chartHeight * 0.9);
